            ...
            <form className='bg-white flex flex-col justify-center items-center gap-10'>
                ...
                <div id='middleSection' className='w-3/4 h-auto flex flex-col items-center gap-5'>
                    ...
                    <div id='userName' className='w-1/2 h-7 flex justify-items-center'>
                        <input className='bg-transparent border-b-2 border-b-[#658221] w-full h-full p-5 outline-none' placeholder='Prenom et nom' type="text" {...register('username')}/>
                    </div>
                    <div id='emailAddress'className='w-1/2 h-7 flex justify-items-center rounded-md'>
                        <input className='bg-transparent border-b-2 border-[#658221] w-full h-full p-5 outline-none' placeholder='Adresse email' type="email" {...register('email')}/>
                    </div>
                    <div id='password' className='w-1/2 h-7 flex justify-items-center rounded-md'>
                        <input className='bg-transparent border-b-2 border-[#658221] w-full h-full p-5 outline-none' placeholder='Mot de passe'  type="password" {...register('password')}/>
                    </div>
                </div>
