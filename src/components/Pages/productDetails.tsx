        ...
        <>
            ...
            <MiddleSection>
                <div id="content" className="w-full h-auto flex flex-row mb-20">
                    ...
                    <div id="mainSection" className='w-[100%] h-screen flex flex-row justify-center gap-20 py-20'>
                        <div id="productImage" className="hidden lg:flex items-center lg:w-[30%] lg:h-[90%]">
